...
function SliderComponent({ 
  ...
  const tooltipNode =
    infoTooltip && tooltipOpen && typeof document !== 'undefined'
      ? createPortal(
          <div
            ref={tooltipPanelRef}
            style={tooltipStyle}
            role="tooltip"
            className="fixed z-[9999] rounded-[18px] border border-white/10 bg-[#141414]/95 p-4 text-left opacity-100 shadow-[0_18px_40px_rgba(0,0,0,0.34)] backdrop-blur-xl"
          >
            {infoTooltip.title ? (
