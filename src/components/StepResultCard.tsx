...
export function StepResultCard({ className, children, ...props }: StepResultCardProps) {
  return (
    <div
      className={cn(
        'mb-12 rounded-[24px] border border-white/8 bg-[linear-gradient(180deg,rgba(38,38,38,0.4),rgba(18,18,18,0.18))] p-5 text-center shadow-[0_14px_34px_rgba(0,0,0,0.22)] backdrop-blur-xl md:p-6',
        className,
      )}
      {...props}
    >
