  ...
  ({ className, interactive, selected, children, onKeyDown, role, tabIndex, ...props }, ref) => {
    ...
    return (
      <div
        ...
        className={cn(
          "bg-[linear-gradient(180deg,rgba(38,38,38,0.4),rgba(18,18,18,0.18))] backdrop-blur-2xl border border-white/[0.08] shadow-[0_8px_28px_rgba(0,0,0,0.32)] shadow-black/50 rounded-[28px] p-6 sm:p-8 transition-all duration-300 relative",
          interactive && "cursor-pointer hover:border-white/12 hover:bg-[rgba(42,42,42,0.12)] hover:-translate-y-1 hover:shadow-[0_14px_40px_rgba(0,0,0,0.42)] focus-visible:border-amber-gold/40 focus-visible:bg-[rgba(42,42,42,0.14)]",
